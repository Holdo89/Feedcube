...
if($_SESSION["username"]=='externes_feedback'){
...
$query = "SELECT ".$Frage.", Datum, Leistung FROM externes_feedback WHERE Datum <= '".$datum_min." 23:59:59' AND Datum >= '".$datum_max." 23:59:59'AND ".$Frage." != '' AND Username='".$_SESSION["username"]."' AND Leistung LIKE '".$Leistung."' ORDER BY Datum DESC";
