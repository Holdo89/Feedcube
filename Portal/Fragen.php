...
<script type="text/javascript" src="navigation.js"></script>	
    <div class="header">
        ...
        <a class="image" style="padding:0px; padding-bottom:5px;"href="Start.php">
			...
			<div class="dropdown">
			<button class="dropbtn" style="background-color: #ddd; color: black;">Optionen 
      			<i class="fa fa-caret-down"></i>
    		</button>
				<div class="dropdown-content">
					<a href="Fragen.php"  class="active"><i class="fa fa-question-circle-o" aria-hidden="true"></i> Feedbackfragen</a>
