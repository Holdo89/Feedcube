<div id="FragenInfo_Modal" class="modal" style="display:none;">
	<form class= "modalform" style="grid-template-columns: auto" action"#" onsubmit="hideinformation(); return false" method="post">
		...
		<p style="text-align:left">
		    Hier werden bestehende Fragen bearbeitet und neue Fragen hinzugefügt, die bei Kundenbefragungen beantwortet werden. Dabei kann zwischen 4 verschiedenen Fragentypen unterschieden werden.   
        </p>
        <p style="text-align:left">
		...
		<p style="text-align:left">
		<i style="font-size:20px; color:blue" class="fas fa-info"></i> Für die Antwortmöglichkeiten bei Bewertungen und Multiplechoice	Fragen können vordefinierte Optionen gewählt werden, oder fragenspezifische Antwortmöglichkeiten erstellt werden, die nicht bei anderen Fragen wiederverwendet werden.  
		</p>
		<p style="text-align:left">
