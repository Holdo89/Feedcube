...
<div class="content">
    <div><?php if($host[0]=="test") echo '<img id="icon" class="btn" src="../assets/brand/FEEDCUBE_logo_login.svg" alt="" width="270" height="90" style="margin-bottom:20%">';?></div>
    <button id="element" onclick = "pageRedirect()"><i class="fa fa-cogs" aria-hidden="true" style="font-size:25px"></i><br>Erste Konfiguration</button>
    <button id="element2" onclick = "skipIntro()"><i class="fa fa-forward" aria-hidden="true" style="font-size:25px"></i><br>Überspringen</button>
</div>
