...
<div id ="UmfrageMöglichkeiten" class="dropdown" style="overflow:visible; text-align:left">
		...
		<div style="text-align:left;font-size:12pt; margin-top:8px;cursor: pointer;" onclick="intern_export_data()"><i id="filtericon" class="fa fa-file-csv" style="font-size:15px;color:green;" aria-hidden="true"></i> CSV</div>
		</div>
		</div>
<?php
	if($IsAdmin == 1)
