...
<script type="text/javascript" src="navigation.js"></script>	
    <div class="header">
        ...
        <a class="image" style="padding:0px; padding-bottom:5px;"href="Start.php">
			...
			<div class="dropdown-content">
				<a href="Intern_noadmin.php"><i class="fa fa-bullhorn" aria-hidden="true"></i> Feedback</a>
     			<a href="interner_blog_noadmin.php" class="active"><i class="fa fa-comments-o" aria-hidden="true"></i> Blog</a>
			</div>
			</div>
        ...
        <h1>Interner Blog <i class="fa fa-comments-o" aria-hidden="true"></i></h1>
    </div>
