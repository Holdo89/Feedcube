...
while($row = mysqli_fetch_assoc($result))
{
    ...
    <input type='checkbox' style='margin-left:0px; display:none' id='".$row["ID"]."_Multiplechoice_englisch' name='checkboxenglisch[]' value='".$row["Answers_Englisch"]."' onclick='return false' checked>
