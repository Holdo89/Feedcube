...
include "IsAdmincheck.php";
 ...
 if($Leistung !="undefined"){
	...
	{
		$sql_leistungen = "SELECT COUNT(ID) AS Anzahl FROM kursfeedback WHERE Datum <= '".$datum_min." 23:59:59' AND Datum >= '".$datum_max." 00:00:00' AND Username LIKE '".$Trainer."' AND Leistung=".$row["ID"];
