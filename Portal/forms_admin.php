...
function load_country_data(limit, start, scrollcounter)
    ...
    if (this.readyState == 4 && this.status == 200) {
		...
		{	
			blog.innerHTML='<p><label style="margin-top:30px">Es wurde noch kein Feedback abgegeben</label></p> <img src="../assets/brand/empty.png" alt="" class="undraw_chart_empty">';
