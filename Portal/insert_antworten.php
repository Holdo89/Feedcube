...
$Answers_Englisch = $_REQUEST["englisch_answers_Bewertung"];
$neue_Antwort = mysqli_real_escape_string($link, $_REQUEST["neue_Antwort"]);

$sql = "INSERT INTO bewertung_answers (Answers, Answers_Englisch, post_order_no, post_id) VALUES ('$neue_Antwort','$Answers_Englisch','$last_order','$last_order')";
