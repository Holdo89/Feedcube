...
<label class="Auswahl">Frage: </label>
	...
	if($IsAdmin == 1)
	{
		echo'<div style="text-align:left;font-size:18px; margin-top:8px;" onclick="intern_export_data()"><i id="filtericon" class="fa fa-download" style="font-size:15px;" aria-hidden="true"></i> Export</div>';
		echo'<div style="text-align:left;font-size:18px; margin-top:8px;" onclick="intern_delete_data()"><i id="filtericon" class="fa fa-trash" style="font-size:15px;" aria-hidden="true"></i> Löschen</div>';
	}
	else{
