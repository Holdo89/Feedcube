<?php
 ...
 echo"\n";
    ...
    $sql = "SELECT * FROM kursfeedback WHERE Datum <= '".$datum_min." 23:59:59' AND Datum >= '".$datum_max." 00:00:00'AND Leistung LIKE '".$Leistung."' AND Username = '".$Trainer."' ORDER BY Datum DESC";
    $result=mysqli_query($link,$sql);
