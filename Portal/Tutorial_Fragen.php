...
<script type="text/javascript" src="navigation.js"></script>	
	...
	<form style="margin-bottom:40px;" action="Tutorial_insert_fragen.php" method="post">
...
<div id="FragenInfo_Modal" class="modal" style="display:none;">
	<form class= "modalform" style="grid-template-columns: auto" action"#" onsubmit="hideinformation(); return false" method="post">
		...
		<div>		
		<h4 style="font-size:30px; margin-bottom:10px;"><img src="../assets/brand/questionmark.png" width="60"> Fragen </h4>
        ...
        <p style="text-align:left">
        <b>Singlechoice</b> - Fragen bei denen genau eine Antwortmöglichkeit gewählt wird. <br><br>
        <b>Multiplechoice</b> - Fragen bei denen mehrere oder keine Antwortmöglichkeit gewählt wird.<br><br>
        <b>Schieberegler</b> - Durch Verschieben eines Reglers wird ein Zahlenwert ermittelt und als Bewertung abgegeben.<br><br>
        <b>Text</b> - Fragen werden durch ein Kommentar in textform beantwortet.<br><br>
        Um Antworten zu wählen die bei einer Frage gewählt werden können klicke <i class="fa fa-pencil" aria-hidden="true"></i>.     
		</p>
